...
@NoArgsConstructor
@AllArgsConstructor
@Schema(name = "InventoryReservationRequest", description = "Request payload for reserving inventory for order")
public class InventoryReservationRequest {
    ...
    @Schema(description = "Quantity of the product to reserve", example = "2", minimum = "1", requiredMode = Schema.RequiredMode.REQUIRED)
